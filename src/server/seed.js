...
const seed = async () =>{
   const usersData = [
    {signup_date:'12/15/2021', username:'user1', password:'password1', email:'user1@email.com', phone:'123-456-7890', first_name:'John', last_name:'Doe', can_sell:'true', address:'110 main street'},
    {signup_date:'12/16/2021', username:'user2', password:'password2', email:'user2@email.com', phone:'234-567-8901', first_name:'Jason', last_name:'Smith', can_sell:'true', address:'220 oak street'},
    {signup_date:'12/17/2021', username:'user3', password:'password3', email:'user3@email.com', phone:'345-678-9012', first_name:'Tom', last_name:'James', can_sell:'true', address:'330 market street'},
    {signup_date:'12/18/2021', username:'user4', password:'password4', email:'user4@email.com', phone:'456-789-0123', first_name:'Fred', last_name:'Lincoln', can_sell:'false', address:'440 oakland street'},
    {signup_date:'12/19/2021', username:'user5', password:'password5', email:'user5@email.com', phone:'567-890-1234', first_name:'Jake', last_name:'Carter', can_sell:'false', address:'550 queen street'},
    {signup_date:'12/20/2021', username:'user6', password:'password6', email:'user6@email.com', phone:'678-901-2345', first_name:'Mike', last_name:'Grayson', can_sell:'false', address:'660 sunset boulevard'},  
];
